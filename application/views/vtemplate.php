                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile_info">
                                <span>Welcome,</span><h2>Anthony Fernando</h2>
                            </div>
                        </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    <li>
                                        <a><i class="fa fa-users"></i> Data Master <span class="fa fa-chevron-down"></span></a>

                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="<?= base_url(); ?>dashboard/master_guru">Master Guru</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_siswa">Master Siswa</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_kelas">Master Kelas</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_walikelas">Master Wali Kelas</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_peserta">Master Peserta</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_mapel">Master Mata Pelajaran</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_jadwal">Master Jadwal</a></li>
                                            <li><a href="<?= base_url(); ?>dashboard/master_user">Master User</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
